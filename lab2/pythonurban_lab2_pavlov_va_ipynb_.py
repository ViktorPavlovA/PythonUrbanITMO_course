# -*- coding: utf-8 -*-
"""PythonUrban_lab2 Pavlov VA.ipynb"

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/13esCez70MraxKNbBruchlydrd_sEW2w3
...
# %cd /content/drive/My Drive/Colab Notebooks/urban_course/ #переход в папку с курсом
...
TERRITORY_NAME = "R369514"  # название территории для которой будут строиться слои

# TODO указать ссылку на файл из вашего github репозитория, которая начинается с https://raw.githubusercontent.com/
# изменить на свое 
KGIOP_FILE_URL = "https://raw.githubusercontent.com/ViktorPavlovA/PythonUrbanITMO_course/main/geojson_sloi/kgiop_objects.geojson"  # ссылка на слой с объектами культурного наследия
STREETS_FILE_URL = "https://raw.githubusercontent.com/ViktorPavlovA/PythonUrbanITMO_course/main/geojson_sloi/streets.geojson"  # ссылка на слой с улицами
...
# TODO сохранить слой в географической проекции в формате GeoJSON
gdf_new.to_crs(4326).to_file('kgiopdistrict.geojson', driver='GeoJSON')
